...
<div align="center">
Programmer skilled in **C**, **C++**, **Java**, and frontend development with **HTML** & **CSS**. Familiar with backend tools like Maven and database management using MySQL. Comfortable working with VS Code and GitHub for development and version control. Currently focusing on DSA and competitive problem-solving to strengthen algorithmic thinking.
</div>  
